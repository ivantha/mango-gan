...
class LeafGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:  # define discriminators
            ...
            if not self.is_using_mask:
                ...
                load_path = "../LFLSeg/pretrained_model/LFLSeg_resnet101.pth"
    ...
    def get_masking(self, tensor, threshold):
        ...
        return torch.from_numpy(background_mask).unsqueeze(0).to(self.device), torch.from_numpy(
            foreground_mask).unsqueeze(0).to(self.device)
